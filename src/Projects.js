        ...
        <Col>
          <div class="card text-white bg-dark mb-3">
            <div class="card-body">
              ...
              <p class="card-text">
                A Call rating engine developed as my Final Yeat Project. Hosted
        ...
        <Col>
          <div class="card text-white bg-dark mb-3">
            <div class="card-body">
              ...
              <p class="card-text">
                A number of simple programs written in C throughout the course
                of my firstyear Programming I Module
              </p>
              <p class="card-text">
